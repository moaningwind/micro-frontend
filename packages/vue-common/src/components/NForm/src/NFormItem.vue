<template>
  <!-- input -->
  <el-input v-if="formData.formType === 'input'" v-model="returnFormValue[formData.code]" v-bind="realFormData" v-on="listeners" />

  <!-- textarea -->
  <el-input v-else-if="formData.formType === 'textarea'" v-model="returnFormValue[formData.code]" type="textarea" v-bind="realFormData" v-on="listeners" />

  <!-- date -->
  <el-date-picker v-else-if="formData.formType === 'date'" v-model="returnFormValue[formData.code]" v-bind="realFormData" v-on="listeners" />
  ...
  <!-- radio -->
  <el-radio-group v-else-if="formData.formType === 'radio'" v-model="returnFormValue[formData.code]">
  ...
  <!-- checkbox -->
  <el-checkbox-group v-else-if="formData.formType === 'checkbox'" v-model="returnFormValue[formData.code]">
    <el-checkbox v-for="item in formData.data" :key="item[optionValue]" :type="item.code" :label="item[optionValue]">
      {{ item[optionLabel] }}
    </el-checkbox>
  </el-checkbox-group>
